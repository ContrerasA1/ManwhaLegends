    ...
    private void initComponents() {
        ...
        favoritesTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                favoritesTableMouseClicked(evt);
            }
        });
...
int userId = Session.getInstance().getUserId();
    ...
    private void favoritesTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_favoritesTableMouseClicked
        if (evt.getClickCount() == 1 && !evt.isConsumed()) {

        evt.consume(); // prevent duplicate firing
        ...
        if (selectedRow != -1) {
            ...
            new manwhadetails(manwhaId).setVisible(true);
        }
    }

    }//GEN-LAST:event_favoritesTableMouseClicked
